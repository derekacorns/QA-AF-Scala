...
class TestAFUnverifiedRecurring extends UnverifiedUserRecurringTestBase {

    @Test
    def createUserAF(): Unit =  {
      ...
      crUserhttprequest2.body("{\n \"user\": {\n \"email\": \"tstunvrec1946@acorns.com\",\n \"password\": \"Welcome1\"\n" +
      ...
      crUserhttprequest2.body("{ \"token\":\"" + usrToken + "\",\"user\":{\"profile\":{\"first_name\"" +
        ...
        "\"ssn\":\"962169896\",\"us_resident\":true,\"us_citizen\":true}}}")
